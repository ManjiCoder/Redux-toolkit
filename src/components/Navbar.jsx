...
function Navbar() {
  ...
  return (
    <header className="p-4 text-center text-gray-400">
      ...
      <h1 ref={zoomIn} className="text-6xl font-bold uppercase my-8 transition-transform duration-500 ease-in-out">
        Admin table
      </h1>
      <h6>One Destination for complete Web Development</h6>
      <nav>
        <ul className="mt-5 flex text-xl font-semibold space-x-3 justify-between bg-slate-100 lg:w-4/6 mx-auto px-5">
          {li.map((item) => (
